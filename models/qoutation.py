...
class crm_leads(models.Model):
    ...
    def proposal_button(self):
        form_view = self.env.ref('insurance_broker_system_blackbelts-master.form_proposal_opp')
    ...
    def create_policy(self):
        form_view = self.env.ref('insurance_broker_system_blackbelts-master.my_view_for_policy_form_kmlo1')
